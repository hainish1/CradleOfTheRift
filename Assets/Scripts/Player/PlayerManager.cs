...
public class PlayerManager : Entity
{
    ...
    void LateUpdate()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Tab))
        {
            ...
            Debug.Log($"Health: {Stats.Health}, MoveSpeed: {Stats.MoveSpeed}, MeleeAttackCooldown: {Stats.MeleeAttackSpeed}, ProjectileFireRate: {Stats.ProjectileFireRate}, FireChargeCooldown: {Stats.FireChargeCooldown} , Projectile Damage: {Stats.ProjectileDamage}, Melee Damage: {Stats.MeleeDamage}, Slam Damage: {Stats.SlamDamage}{flightInfo}");
        }
    }
