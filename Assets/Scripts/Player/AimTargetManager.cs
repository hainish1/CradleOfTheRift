...
namespace Unity.Cinemachine.Samples
{
    ...
    public class AimTargetManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            if (ReticleCanvas) ReticleCanvas.enabled = true;
            if (AimTargetIndicator)
            {
                AimTargetIndicator.anchorMin = AimTargetIndicator.anchorMax = AimTargetIndicator.pivot = new Vector2(0.5f, 0.5f);
                AimTargetIndicator.anchoredPosition = Vector2.zero;
            }
        }
