...
public class BaseStats : ScriptableObject
{
    ...
    [Tooltip("Per-weapon melee animation speed")]
    public float spearMeleeAnimationSpeed = 1;
    public float axeMeleeAnimationSpeed = 1;
    public float maceMeleeAnimationSpeed = 1;
    public float staffMeleeAnimationSpeed = 1;
