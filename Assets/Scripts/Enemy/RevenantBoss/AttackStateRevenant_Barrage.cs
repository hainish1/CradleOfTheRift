...
/// </summary>
public class AttackStateRevenant_Barrage : EnemyState
{
    ...
    public AttackStateRevenant_Barrage(Enemy enemy, EnemyStateMachine stateMachine) : base(enemy, stateMachine)
    {
